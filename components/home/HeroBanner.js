...
const HeroBanner = ({ titre, description, subDescription }) => {
    return (
        <>
            <div className="h-4/12  lg:px-[163px] shadow-xl/20 p-10  text-white bg-[linear-gradient(90deg,_#0a5197_35%,_#0080ff_100%)] rounded-b-[50px]">
                <TopHeroBanner />
                ...
                <p className="font-semibold text-[clamp(1rem,2vw,1.25rem)] mb-[35px] ">
                    {subDescription}
                </p>
            </div>
        </>
