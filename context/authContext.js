...
export const AuthProvider = ({ children }) => {
    ...
    const login = async (dataForm) => {
        ...
        try {
            ...
            toast.error("Errreur de connexion, Vérifiez votre connexion internet ", DATA_TOAST);
    ...
    const signUp = async (dataForm) => {
        ...
        try {
            ...
            toast.success("Compte créé ! Vérifiez votre boîte mail pour confirmer.", DATA_TOAST);
            
        } catch (e) {
            toast.error("Errreur de connexion, Vérifier votre connexion internet ", DATA_TOAST);
            throw new Error(`erreur de connexion avec supabase ${e}`);
        }finally {
            setIsLoading(false); 
        }
    ...
    return(
        <AuthContext.Provider value={{login, logout, isLoading, signUp, isAuth: !!user, user}}>
            {children}
            <ToastContainer
