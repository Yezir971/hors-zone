    ...
    const sports = [
        {
            name: 'Football',
            description:
                "Un sport d'équipe populaire joué avec un ballon rond. Objectif : marquer dans le but adverse.",
        ...
        },
        {
            name: 'Basketball',
            description:
                "Deux équipes s'affrontent pour marquer des paniers en lançant un ballon dans un arceau.",
            image: 'https://www.shutterstock.com/image-vector/let-madness-begin-march-tshirt-600nw-2328754759.jpg',
        },
        {
            name: 'Tennis',
            description:
                'Un sport de raquette qui se joue à un ou deux joueurs de chaque côté du filet.',
        ...
        },
        {
            name: 'Natation',
            description:
                'Un sport individuel ou en relais qui consiste à parcourir une distance en nageant.',
            ...
            <header className="bg-indigo-600 text-white py-6 shadow">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <p className="text-sm mt-1">
                        Découvrez et explorez vos sports préférés
                    </p>
                </div>
            </header>
